<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocalisationTroisRivieres.aspx.vb" Inherits="Test_ultime.LocalisationTroisRivieres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript">
		function initialisation(){
		    var centreCarte = new google.maps.LatLng(46.340126, -72.543859);
		var optionsCarte = {
			zoom: 15,
			center: centreCarte
		}
		...
		var myMarker = new google.maps.Marker({
			...
			map: maCarte,
			title: "Nouvhotel Trois rivières"
			});
		}
