<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocalisationSherbrookeCentreDesCongres.aspx.vb" Inherits="Test_ultime.LocalisationSherbrookeCentreDesCongres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript">
		function initialisation(){
		    var centreCarte = new google.maps.LatLng(45.403567, -71.874654);
		var optionsCarte = {
			zoom: 15,
			center: centreCarte
		}
		...
		var myMarker = new google.maps.Marker({
			...
			map: maCarte,
			title: "Nouvhotel Sherbrooke-Centre des congrès"
			});
		}
