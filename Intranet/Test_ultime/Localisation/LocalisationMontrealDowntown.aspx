<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocalisationMontrealDowntown.aspx.vb" Inherits="Test_ultime.LocalisationMontrealDowntown" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript">
		function initialisation(){
		    var centreCarte = new google.maps.LatLng(45.502485, -73.568241);
		var optionsCarte = {
			zoom: 15,
			center: centreCarte
		}
		...
		var myMarker = new google.maps.Marker({
			...
			map: maCarte,
			title: "Nouvhotel Montreal Downtown"
			});
		}
